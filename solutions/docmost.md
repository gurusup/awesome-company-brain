...
| Activation evidence (proof retrieved context is actually used, not just retrievable) | Partial: the paid Enterprise "AI Answers" chat is documented as answering with source citations across pages and attachments — evidence retrieved context is cited in responses; not applicable to the free Community Edition, which has no AI layer. |
