...
| Activation evidence (proof retrieved context is actually used, not just retrievable) | Unknown — not documented beyond the retrieval/citation features described above; no logging or citation-format detail was found for what the AI Assistant actually pulls into an answer. |
