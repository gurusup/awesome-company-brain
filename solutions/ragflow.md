...
| Activation evidence (proof retrieved context is actually used, not just retrievable) | Documented: answers include "grounded citations" with traceable reference visualization — direct evidence retrieved chunks are surfaced in-answer, not just indexed. |
