...
These are the ten evaluation dimensions used across every [solution profile](../solutions/README.md). They exist so that "GuruSup vs. Glean vs. Confluence" comparisons are judged on the same axes instead of on marketing language.
